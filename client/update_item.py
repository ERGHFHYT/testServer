...
def update(data_entry, the_name_of_the_table):
    if the_name_of_the_table == "password_table":
        ...
        tool = client.client_classes_folder.Custom_window.Custom_window(root_2, "בלבש סיסמה",
        ...
        root_2 = customtkinter.CTk()
        tool = client.client_classes_folder.Custom_window.Custom_window(root_2, "בלבש אנשים",
